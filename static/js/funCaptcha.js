...
return new Promise((resolve)=>new FunCaptcha({public_key:"A2A14B1D-1AF3-C791-9BBC-EE33CC7A0A6F",target_html:captchaDivId,callback:resolve,data:{blob:fieldData}}))}
